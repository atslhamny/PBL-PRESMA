...
if (isset($_REQUEST['simpan'])) {
    ...
    peran_mahasiswa = '$peran_mahasiswa', 
    ...
    if ($stmt === false || !sqlsrv_execute($stmt)) {
        die("Error in updating data: " . print_r(sqlsrv_errors(), true));
    }
        ...
        <div class="card">
            <div class="col-sm-12" style="padding: 10px;">
                <ol class="breadcrumb float-sm-left" style="padding: 0; margin: 0;">
                    ...
                    <li class="breadcrumb-item active">Edit Kompetisi</li>
                </ol>
            </div>
        </div>
    </section>
        ...
        <div class="card">
            <div class="container mt-5">
                ...
                <div class="card card-primary">
                    ...
                    <?php
                    $query0 = "SELECT * from kompetisi where id='$_REQUEST[id]'";
                    // Menyiapkan dan mengeksekusi query untuk mengambil data kompetisi
                    $stmt0 = sqlsrv_prepare($db, $query0);
                    if ($stmt0 === false || !sqlsrv_execute($stmt0)) {
                        die(print_r(sqlsrv_errors(), true));
                    }
                    while ($row0 = sqlsrv_fetch_array($stmt0, SQLSRV_FETCH_ASSOC)) {
                    ?>

                        <form action="index.php?page=edit_kompetisi_admin" method="post" enctype='multipart/form-data'>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                                                echo "<option value='$row[id]' ";
                                                if ($row0['id_jenis_kompetisi'] == $row['id']) {
                                                    echo " selected";
                                                }
                                                echo ">$row[jenis_kompetisi]</option>";
                                            }
                                            echo "</select>";
                                            ?>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                                                echo "<option value='$row[id]' ";
                                                if ($row0['id_tingkat_kompetisi'] == $row['id']) {
                                                    echo " selected";
                                                }
                                                echo ">$row[tingkat_kompetisi]</option>";
                                            }
                                            echo "</select>";
                                            ?>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input class="form-control" value='<?php echo $row0['judul_kompetisi']; ?>' name=judul_kompetisi type="text" placeholder="Judul Kompetisi">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input class="form-control" value='<?php echo $row0['judul_kompetisi_en']; ?>' name='judul_kompetisi_en' type="text" placeholder="Competition English">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input class="form-control" name='tempat_kompetisi' value='<?php echo $row0['tempat_kompetisi']; ?>' type="text" placeholder="Tempat Kompetisi">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input class="form-control" name=tempat_kompetisi_en value='<?php echo $row0['tempat_kompetisi_en']; ?>' type="text" placeholder="Competition Veneu">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input class="form-control" value='<?php echo $row0['url_kompetisi']; ?>' name=url_kompetisi type="text">
                                        </div>
                                    </div>

                                    <?php
                                    $tanggal_mulai = $row0['tanggal_mulai']; // Contoh tanggal
                                    ?>

                                    <div class="form-group row">
                                        <label for="tanggal_mulai" class="col-sm-3 col-form-label">Tanggal Mulai</label>
                                        <div class="col-sm-3">
                                            <input class="form-control" value='<?php echo $tanggal_mulai->format('Y-m-d'); ?>' name='tanggal_mulai' type="date">
                                        </div>
                                    </div>

                                    <?php
                                    $tanggal_akhir = $row0['tanggal_akhir']; // Contoh tanggal
                                    ?>

                                    <div class="form-group row">
                                        <label for="tanggal_akhir" class="col-sm-3 col-form-label">Tanggal Akhir</label>
                                        <div class="col-sm-3">
                                            <input class="form-control" value='<?php echo $tanggal_akhir->format('Y-m-d'); ?>' name='tanggal_akhir' type="date">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" value='<?php echo $row0['jumlah_pt']; ?>' name='jumlah_pt' type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <input value='<?php echo $row0['jumlah_peserta']; ?>' name=jumlah_peserta class="form-control" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input value='<?php echo $row0['no_surat_tugas']; ?>' name='no_surat_tugas' class="form-control" type="text">
                                        </div>
                                    </div>

                                    <?php
                                    $tanggal_surat_tugas = $row0['tanggal_surat_tugas']; // Contoh tanggal
                                    ?>

                                    <div class="form-group row">
                                        <label for="tanggal_surat_tugas" class="col-sm-3 col-form-label">Tanggal Surat Tugas</label>
                                        <div class="col-sm-3">
                                            <input value='<?php echo $tanggal_surat_tugas->format('Y-m-d'); ?>' name='tanggal_surat_tugas' class="form-control" type="date">
                                        </div>
                                    </div>
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <?php if (!empty($row0['file_sertifikat'])): ?>
                                                    <div id="existingPreview">
                                                        <p>Preview Sertifikat Saat Ini:</p>
                                                        <img src="upload/<?php echo htmlspecialchars($row0['file_sertifikat']); ?>" alt="File Sertifikat" style="max-width: 200px; max-height: 200px; border: 1px solid #ddd; padding: 5px;">
                                                    </div>
                                                <?php endif; ?>
                                                <div class="input-group">
                                                    <div class="custom-file">
                                                        <input name="file_sertifikat" type="file" class="custom-file-input" id="file_sertifikat" accept=".jpeg,.png,.jpg,.pdf" onchange="previewImage(this); validateFileSize(this);">
                                                        <label class="custom-file-label" for="file_sertifikat">Choose file</label>
                                                    </div>
                                                </div>
                                                <div id="imagePreviewSertifikat" style="margin-top: 10px;"></div> <!-- Tempat untuk preview gambar baru -->
                                            </div>
                                        </div>
                                        <!-- /.card-body -->
                                    </div>
